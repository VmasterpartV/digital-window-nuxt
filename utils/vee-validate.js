...
extend('password', (value) => {
  if (value.length >= 8) {
    ...
    if (
      ...
      caracter_raro == true &&
      numero == true
    ) { return true } else if (!mayuscula) { return 'La contraseña debe contener al menos 1 letra mayúscula' } else if (!minuscula) { return 'La contraseña debe contener al menos 1 letra minúscula' } else if (!caracter_raro) { return 'La contraseña debe contener al menos 1 símbolo' } else if (!numero) { return 'La contraseña debe contener al menos 1 número' }
  }
